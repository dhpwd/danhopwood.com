...
- Fifth blog post drafted ("Forgetting isn't the problem", `draft: true`, slug: `forgetting-isnt-the-problem`): argument piece on AI codebase coherence – contractors analogy, two dimensions of code quality, "continuity has a counter, coherence doesn't" payoff. Held for staggered release a few days after Post 4. The original long-form Post 4 draft was split into two cross-linked posts (practical → 4, argument → 5). Post 4 has a commented-out forward-link aside to be uncommented when Post 5 ships
