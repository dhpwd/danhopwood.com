...
- **Content** (prose, post furniture): Geist. Links use dashed underlines (`decoration-dashed underline-offset-4`) – the site's signature – at body weight. The underline is the link signal on its own, so don't add weight or colour to compensate for its muted decoration: at `strong`'s weight a link and an emphasised phrase become indistinguishable
